    ...
    <>
      ...
      {user ? (
        <div className="dropdown dropdown-end ">
          ...
          <ul tabIndex={0} className="dropdown-content menu p-2 shadow  rounded-box w-52 bg-slate-200 text-black ">
            <li>
              <Link to="/dashboard" className="uppercase font-semibold mx-auto mt-10  ">
                Dashboard Home
              </Link>
            </li>
            <li>
    ...
    <div className="navbar py-6 justify-between max-w-7xl mx-auto ">
      <div className="navbar-start ">
        ...
        <Link to="/" className="btn btn-ghost normal-case  uppercase text-xl">
          <button className="btn px-2 btn-primary text-white mr-4 text-3xl font-bold ">LHT</button> Licota Hand tools
        </Link>
      </div>
